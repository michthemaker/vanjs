...
export const $$__hmr__OtherName = (): any => {
  return (
  div('name')
  )
};
...
export const OtherName = (props) => __VAN_HMR__.registerRender('src/counter.ts:OtherName', $$__hmr__OtherName, props);
...
if (import.meta.hot) {
  import.meta.hot.accept((newModule) => {
    if (newModule) {
      __VAN_HMR__.rerender('src/counter.ts:OtherName', newModule.$$__hmr__OtherName);
